...
docker buildx build --platform linux/amd64 -t doanquoctoan/devops:deramedia -f dockerfile .

docker push doanquoctoan/devops:deramedia

docker pull doanquoctoan/devops:deramedia
